...
@interface ALBBWTMTLModel : NSObject <NSCopying>
...
- (void)mergeValueForKey:(NSString *)key fromModel:(ALBBWTMTLModel *)model;
...
- (void)mergeValuesForKeysFromModel:(ALBBWTMTLModel *)model;
...
@interface ALBBWTMTLModel (Validation)
...
@interface ALBBWTMTLModel (Unavailable)
