...
extern NSString * const ALBBWTMTLJSONAdapterErrorDomain;

// +classForParsingJSONDictionary: returned nil for the given dictionary.
extern const NSInteger ALBBWTMTLJSONAdapterErrorNoClassFound;

// The provided JSONDictionary is not valid.
extern const NSInteger ALBBWTMTLJSONAdapterErrorInvalidJSONDictionary;

// The model's implementation of +JSONKeyPathsByPropertyKey included a key which
// does not actually exist in +propertyKeys.
extern const NSInteger ALBBWTMTLJSONAdapterErrorInvalidJSONMapping;
...
@property (nonatomic, strong, readonly) ALBBWTMTLModel<ALBBWTMTLJSONSerializing> *model;
...
+ (NSDictionary *)JSONDictionaryFromModel:(ALBBWTMTLModel<ALBBWTMTLJSONSerializing> *)model;
...
// model - The model to use for JSON serialization. This argument must not be
//         nil.
- (id)initWithModel:(ALBBWTMTLModel<ALBBWTMTLJSONSerializing> *)model;
...
@interface ALBBWTMTLJSONAdapter (Deprecated)
