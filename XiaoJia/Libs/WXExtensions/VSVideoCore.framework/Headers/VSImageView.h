...
/**
 The VSContext that hold the underlying CIContext for rendering the CIImage's
 ...
 */
@property (strong, nonatomic) VSContext *__nullable context;
...
/**
 ...
 when needed. This avoids creating multiple CIImage if the VSImageView can't render them
 as fast.
 */
...
- (CVPixelBufferRef __nullable)renderedPixelBuffer;
