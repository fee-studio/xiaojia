...
#import "VSPhotoConfiguration.h"
#import "VSRecorderTools.h"
#import "VSRecorderDelegate.h"

// Convenience
#import "VSRecorderHeader.h"
 ...
 */
@property (readonly, nonatomic) VSPhotoConfiguration *__nonnull photoConfiguration;
...
/**
 Will be true if the VSRecorder is currently recording
 */
 ...
 */
@property (assign, nonatomic) VSFlashMode flashMode;
...
/**
 Set the delegate used to receive messages for the VSRecorder
 */
@property (weak, nonatomic) id<VSRecorderDelegate> __nullable delegate;

/**
 The record session to which the recorder will flow the camera/microphone buffers
 */
@property (strong, nonatomic) VSRecordSession *__nullable session;
...
/**
 ...
 by VSVideoConfiguration and VSAudioConfiguration. It will internally 
...
/**
 The dispatch queue that the VSRecorder uses for sending messages to the attached
 VSRecordSession.
 */
 ...
 */
+ (VSRecorder *__nonnull)sharedRecorder;
